...
function run() {
    ...
    if (checkCookie()) {
        if ($.cookie(cookieName)
            .indexOf('{') == -1) {
            alert("Essayer de changer le nom de la variable cookieName. Si le problÃƒÆ’Ã‚Â¨me persiste, rendez vous sur le forum.");
            ...
            UI.ErrorMessage("A cause d'une mise a jour, les donnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es ont ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s perdues. Veuillez recommencer les assignations de touches.", 5000);
...
function addTable() {
    ...
    $('#divFAPress')
        .append($(
            "<table id='faKeySettings' class='vis' style='width:100%' cellspacing='0'><thead><tr><th colspan='3'><em>ParamÃƒÂ¨tres</em> - <a href'#' id='showSettings' onclick='return doSettings()'>Cacher</a></thead><tbody id='bodySettings'><tr><td colspan='1' align='center'><input type='checkbox' id='chbLoadPages' onclick='return chkBoxClick($(this).is(\":checked\"), " +
            ...
            "' onchange='onlyNum(this);' disabled> Ãƒ  <input type='text' id='txtLastPage' size='2' maxlength='2' value='" + userset[pos.s.lp] +
            ...
            .remaxes +
            ")'> <img src='https://media.innogamescdn.com/com_DS_FR/Scripts/Pillage/attacks.png' title='Attaques en cours (spÃƒÂ©cifier Ãƒ  partir de combien)' alt='' class='tooltip' /> Attaques en cours <input type='text' id='txtNbAttacks' size='2' maxlength='2' value='" + userset[pos.s.MaxNbAttacks] + "' onchange='onlyNum(this)' disabled><input type='checkbox' id='chbRemBlue' onclick='return chkBoxClick($(this).is(\":checked\"), " +
            pos.s.remblue +
            ")'> <img src='https://media.innogamescdn.com/com_DS_FR/Scripts/Pillage/blue.png' title='EspionnÃƒÂ©' alt='' class='tooltip' /> EspionnÃƒÂ© <br><input type='checkbox' id='chbRemGreen' onclick='return chkBoxClick($(this).is(\":checked\"), " +
            pos.s.remgreen +
            ...
            pos.s.remredy +
            ")'> <img src='https://media.innogamescdn.com/com_DS_FR/Scripts/Pillage/red_yellow.png' title='Vaincu, mais bÃƒÂ¢timent(s) endommagÃƒÂ©(s)' alt='' class='tooltip' /> Vaincu, mais endommagÃƒÂ©s<br><input type='checkbox' id='chbRemRedBlue' onclick='return chkBoxClick($(this).is(\":checked\"), " +
            pos.s.remredb +
            ")'> <img src='https://media.innogamescdn.com/com_DS_FR/Scripts/Pillage/red_blue.png' title='Vaincu, mais espionnÃƒÂ©' alt='' class='tooltip' /> Vaincu, mais espionnÃƒÂ©<br><input type='checkbox' id='chbRemRed' onclick='return chkBoxClick($(this).is(\":checked\"), " +
            pos.s.remred +
            ")'> <img src='https://media.innogamescdn.com/com_DS_FR/Scripts/Pillage/red.png' title='DÃƒÂ©fait' alt='' class='tooltip' /> DÃƒÂ©fait</tr><tr><td align='right' colspan='2'><input type='button' class='btn' id='btnSettingsReset' value='Reset' onclick='resetCookie(); UI.SuccessMessage(\"Reset effectuÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©\",1000); run(); return false;'><input type='button' class='btn' id='btnSettingsApply' value='Appliquer' onclick='saveSettings(); run(); return false'><input type='button' class='btn' id='btnSettingsSave' value='Sauvegarder' onclick='saveSettings(); return false;'></tr></tbody></table>"
        ));
...
function saveSettings() {
    ...
    userset[pos.s.MaxNbAttacks] = $('#txtNbAttacks')
        .val();
    setCookie(cookieName, "{" + version + "}[" + userkeys.toString() + "][" + userset.toString() + "]", 180);
    UI.SuccessMessage("ParamÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨tres sauvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s", 1000);
}
        ...
        $.ajax({
            ...
            success: function(data) {
				...
				*/
                ...
                //On change manuellement le village dans les donnÃƒÆ’Ã‚Â©es car ce n'est pas fait automatiquement
